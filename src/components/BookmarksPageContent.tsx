      ...
      {bookmarks.length > 0 ? (
        <div className="space-y-3">
          {bookmarks.map((article) => (
            <div
              key={article.link}
              className="bg-white dark:bg-black rounded-xl border border-gray-200 p-5 hover:shadow-md transition"
            >
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  <a
                    ...
                    className="text-lg font-semibold text-gray-900 dark:text-white hover:text-blue-600 transition line-clamp-2"
                  >
                    {article.title}
                  </a>
                  <div className="flex items-center gap-3 mt-2 text-sm text-gray-500">
                    <span className="font-medium text-gray-700 dark:text-white">{article.source}</span>
                    <span>•</span>
        ...
        <div className="text-center py-16 bg-white dark:bg-black rounded-xl border border-gray-200">
          <div className="text-6xl mb-4">🔖</div>
          <h3 className="text-xl font-semibold text-gray-700 dark:text-white mb-2">{t('empty')}</h3>

    ...
    <div className="bg-white dark:bg-black rounded-2xl border border-gray-200 dark:border-slate-700 p-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a
          ...
          className="flex-1 py-2.5 px-4 bg-black dark:bg-white text-white dark:text-black rounded-lg text-center text-sm font-medium hover:bg-gray-800 dark:hover:bg-neutral-900 transition"
        >
          𝕏 Post
        </a>
      ...
      {'share' in (typeof navigator !== 'undefined' ? navigator : {}) && (
        <button
          ...
          className="w-full mt-2 py-2.5 px-4 bg-gray-900 dark:bg-black text-white rounded-lg text-sm font-medium hover:bg-gray-800 dark:hover:bg-neutral-900 transition"
        >
          📱 Share...
        </button>
      )}
      ...
      <button
        onClick={handleCopy}
        className="w-full mt-2 py-2.5 px-4 bg-gray-100 dark:bg-black text-gray-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-neutral-900 transition"
      >

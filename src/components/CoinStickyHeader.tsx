...
export function CoinStickyHeader({
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 border-b border-gray-200 dark:border-neutral-800 bg-white/95 dark:bg-black/95 backdrop-blur-sm transition-transform duration-200 ${visible ? "translate-y-0" : "-translate-y-full"}`}
    >

      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1 text-sm rounded-lg ${!showChange ? 'bg-gray-900 text-white dark:bg-white dark:text-white' : 'bg-gray-100 dark:bg-black text-gray-600 dark:text-gray-300'}`}
          >
            Value
          </button>
          <button

...
function ShortcutsHelp({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="sticky top-0 bg-white dark:bg-black px-6 py-4 border-b border-gray-100 dark:border-neutral-800 flex items-center justify-between">
                  ...
                  <div key={shortcut.description} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      {shortcut.keys.map((key, i) => (
                        <span key={i}>
                          <kbd className="px-2 py-1 text-xs font-semibold text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-black rounded border border-gray-200 dark:border-neutral-800">
                            {key}
                          </kbd>
        ...
        <div className="px-6 py-4 border-t border-gray-100 dark:border-neutral-800 bg-gray-50 dark:bg-black/50 rounded-b-2xl">

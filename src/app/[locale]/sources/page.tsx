      ...
      <div className="max-w-7xl mx-auto">
        ...
        <main className="px-4 py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="bg-white dark:bg-black rounded-xl p-6 border border-gray-200 dark:border-neutral-800 text-center">
            ...
            {sources.map(source => {
              ...
              return (
                <Link
                  ...
                  className="group bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 overflow-hidden hover:shadow-lg transition"
                >
                  {/* Color Banner */}
          ...
          {/* Info Section */}
          <div className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 p-8">

...
// Source metadata - 96 sources total (21 English + 75 International)
const sourceInfo: Record<string, {
  ...
  dailyhodl: {
    name: 'The Daily Hodl',
    description: 'Daily crypto news site covering Bitcoin, Ethereum, altcoins and blockchain with a focus on market-moving stories.',
    website: 'https://dailyhodl.com',
    twitter: 'TheDailyHodl',
    focus: ['News', 'Markets', 'Altcoins'],
    founded: '2018',
    language: 'English',
    region: 'Global',
  },
  cryptoslate: {
    name: 'CryptoSlate',
    description: 'Crypto news, research, and data platform covering blockchain technology, DeFi, and digital assets.',
    website: 'https://cryptoslate.com',
    twitter: 'CryptoSlate',
    focus: ['News', 'Research', 'Data', 'DeFi'],
    founded: '2017',
    language: 'English',
    region: 'Global',
  },
  beincrypto: {
    name: 'BeInCrypto',
    description: 'Crypto news outlet with a focus on making decentralized finance and blockchain accessible to everyone.',
  ...
  dl_news: {
    name: 'DL News',
    description: 'Independent crypto journalism with investigative reporting on DeFi, Web3, and the people behind the protocols.',
    website: 'https://www.dlnews.com',
    twitter: 'DaboratingNews',
    focus: ['Journalism', 'Investigation', 'DeFi'],
    founded: '2022',
    language: 'English',
    region: 'Global',
  },
  protos: {
    name: 'Protos',
    description: 'Crypto media outlet focused on investigative journalism, market analysis, and critical coverage of the digital assets industry.',
    website: 'https://protos.com',
    twitter: 'ProtosMedia',
    focus: ['Investigation', 'Analysis', 'Markets'],
    founded: '2021',
    language: 'English',
    region: 'Global',
  },
  bitcoinops: {
    name: 'Bitcoin Optech',
    description: 'Bitcoin Optech helps Bitcoin users and businesses integrate scaling technologies. Weekly newsletter covering Bitcoin protocol development.',
    website: 'https://bitcoinops.org',
    twitter: 'bitcoinoptech',
    focus: ['Bitcoin', 'Protocol', 'Development', 'Scaling'],
    founded: '2018',
    language: 'English',
    region: 'Global',
  },
  rekt: {
    name: 'Rekt News',
    description: 'Anonymous DeFi journalism covering hacks, exploits, and the dark side of decentralized finance with editorial commentary.',
    website: 'https://rekt.news',
    focus: ['DeFi', 'Security', 'Hacks', 'Analysis'],
    founded: '2020',
    language: 'English',
    region: 'Global',
  },
  chainalysis_blog: {
    ...
    description: 'Blockchain analytics company providing compliance, investigation, and risk management insights for crypto markets.',
    website: 'https://www.chainalysis.com',
    twitter: 'chainalysis',
    focus: ['Compliance', 'Analytics', 'Investigation', 'Crime'],
    founded: '2014',
    language: 'English',
    region: 'Global',
  },
  flashbots_blog: {
    name: 'Flashbots',
    description: 'Research and development organization focused on mitigating the negative externalities of MEV on Ethereum.',
    website: 'https://www.flashbots.net',
    twitter: 'flashbots',
    focus: ['MEV', 'Ethereum', 'Research', 'Protocol'],
    founded: '2020',
    language: 'English',
    region: 'Global',
  },
  metamask_blog: {
    name: 'MetaMask Blog',
    description: 'Official blog from MetaMask, the leading self-custodial wallet for Ethereum and EVM chains.',
    website: 'https://metamask.io',
    twitter: 'MetaMask',
    focus: ['Wallet', 'Ethereum', 'DApps', 'Web3'],
    founded: '2016',
    language: 'English',
    region: 'Global',
  },
  ledger_blog: {
    name: 'Ledger Blog',
    description: 'Hardware wallet manufacturer providing educational content and security insights for crypto self-custody.',
    website: 'https://www.ledger.com',
    twitter: 'Ledger',
    focus: ['Security', 'Hardware Wallet', 'Self-Custody'],
    founded: '2014',
    language: 'English',
    region: 'Europe',
  },
  immutable_blog: {
    name: 'Immutable Blog',
    description: 'Leading Web3 gaming platform building the infrastructure for next-generation blockchain games.',
    website: 'https://www.immutable.com',
    twitter: 'Immutable',
    focus: ['Gaming', 'NFT', 'Layer 2', 'Web3'],
    founded: '2018',
    language: 'English',
    region: 'Global',
  },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <main className="px-4 py-8">
          {/* Source Header */}
          <div className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 p-6 mb-8">
              ...
              <Link
                ...
                className={`whitespace-nowrap px-4 py-2 rounded-full text-sm font-medium transition ${
                  key === source
                    ...
                    : 'bg-white dark:bg-black border border-gray-200 dark:border-neutral-800 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-neutral-900'
                }`}
              >
                {src.name}
              </Link>
          ...
          {newsData.articles.length > 0 ? (
            ...
            <div className="bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 p-8 text-center">

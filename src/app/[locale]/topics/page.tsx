      ...
      <div className="max-w-7xl mx-auto">
        ...
        <main className="px-4 py-8">
          ...
          <div className="mt-12 text-center bg-white dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 p-8">
            ...
            <Link
              href="/search"
              className="inline-block bg-black dark:bg-white text-white dark:text-black px-6 py-3 rounded-full font-medium hover:bg-gray-800 dark:hover:bg-neutral-900 transition"
            >
              🔍 Search News
            </Link>
          </div>

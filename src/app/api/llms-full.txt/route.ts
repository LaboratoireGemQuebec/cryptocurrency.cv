...
function buildDocument(
  ...
  L.push(
    ...
    '',
    '> Free, real-time cryptocurrency news API aggregating 200+ sources.',
    ...
    '',
    'Aggregates cryptocurrency news from 200+ sources including CoinDesk, The Block,',
    ...
    '',
    '### GET /api/sources',
    'All 200+ news sources with status, RSS URL, language. Returns `sources[]`, `totalActive`.',
    '',
    '### GET /api/sentiment',

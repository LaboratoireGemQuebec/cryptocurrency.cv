...
export const NEWSLETTERS: Newsletter[] = [
  {
    ...
    category: "news",
    sampleSubject:
      "BTC breaks $100K, Ethereum L2 TVL hits record, SEC ruling on staking",
  },
  {
    id: "market-pulse",
    name: "Market Pulse",
    ...
    category: "markets",
    sampleSubject:
      "Weekly: BTC funding rates diverge, stablecoin inflows surge 40%",
  },
  {
    id: "defi-dispatch",
    name: "DeFi Dispatch",
    ...
    category: "defi",
    sampleSubject:
      "This week in DeFi: Aave v4 launch, restaking wars heat up",
  },
  {
    id: "dev-weekly",
    ...
    category: "developer",
    sampleSubject:
      "New: Solana DeFi endpoints, Python SDK v2.0, WebSocket improvements",
  },
  {
    id: "learn-crypto",
    name: "Learn Crypto",
    ...
    category: "education",
    sampleSubject:
      "What are Layer 2s? A beginner's guide to Ethereum scaling",
  },
];

...
export function generateCoinMetadata({
  ...
  return generateSEOMetadata({
    ...
    description: `Get the latest ${name} (${symbol.toUpperCase()}) price, news, charts, and market data. Real-time updates from Crypto Vision.`,
...
export function generateCategoryMetadata({
  ...
  return generateSEOMetadata({
    ...
    description: description || `Latest ${category} cryptocurrency news and updates. Stay informed with Crypto Vision.`,

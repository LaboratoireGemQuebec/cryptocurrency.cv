...
export const GUIDE_SERIES: GuideSeries[] = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "Understand the blockchain, mining, and the technology that powers Bitcoin.",
        order: 2,
        readingTime: "8 min",
      },
      {
        ...
        description:
          "How miners secure the network, earn rewards, and why energy usage matters.",
        order: 3,
        readingTime: "7 min",
      },
      {
        ...
        description:
          "A step-by-step guide to purchasing your first Bitcoin safely.",
        order: 4,
        readingTime: "6 min",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "The token standard that powers thousands of cryptocurrencies on Ethereum.",
        order: 4,
        readingTime: "6 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "From the Merge to Danksharding: what's next for Ethereum's development.",
        order: 6,
        readingTime: "7 min",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "Uniswap, SushiSwap, and the AMM model that powers trustless token swaps.",
        order: 2,
        readingTime: "8 min",
      },
      {
        ...
        description:
          "How to earn rewards by providing liquidity to DeFi protocols.",
        order: 3,
        readingTime: "9 min",
      },
      {
        ...
        description:
          "How pooled assets enable decentralized trading and what LP tokens represent.",
        order: 4,
        readingTime: "7 min",
      },
      {
        ...
        description:
          "The hidden cost of liquidity provision and how to minimize it.",
        order: 5,
        readingTime: "8 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Smart contract exploits, rug pulls, oracle attacks, and how to stay safe.",
        order: 7,
        readingTime: "7 min",
      },
    ],
    ...
    articles: [
      {
        ...
        description:
          "The basics of buying, selling, and trading cryptocurrencies on exchanges.",
        order: 1,
        readingTime: "7 min",
      },
      {
        ...
        description:
          "Market, limit, stop-loss, and take-profit orders — when and how to use each.",
        order: 2,
        readingTime: "7 min",
      },
      {
        ...
        description:
          "Candlestick patterns, support/resistance, volume, and moving averages.",
        order: 3,
        readingTime: "9 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "DCA, swing trading, scalping, and HODLing — find the approach that fits you.",
        order: 5,
        readingTime: "8 min",
      },
      {
    ...
    articles: [
      {
        ...
        title: "What are NFTs?",
        description:
          "Unique digital assets on the blockchain — how they work and why they matter.",
        order: 1,
        readingTime: "7 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Rarity, utility, community, and provenance: understanding NFT pricing.",
        order: 4,
        readingTime: "6 min",
      },
      {
        ...
        description:
          "Wash trading, rug pulls, and how to evaluate projects before buying.",
        order: 5,
        readingTime: "6 min",
      },
    ],
    ...
    articles: [
      {
        ...
        title: "What is Web3?",
        description:
          "From Web1 to Web3: how the internet is evolving toward decentralization.",
        order: 1,
        readingTime: "7 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "How your wallet becomes your identity in the decentralized web.",
        order: 3,
        readingTime: "6 min",
      },
      {
        ...
        description:
          "IPFS, Arweave, and Filecoin: storing data without centralized servers.",
        order: 4,
        readingTime: "6 min",
      },
      {
        ...
        description:
          "Lens Protocol, Farcaster, and the future of decentralized social platforms.",
        order: 5,
        readingTime: "6 min",
      },
      {
        ...
        description:
          "Scalability, UX, adoption barriers, and honest critiques of the Web3 vision.",
        order: 6,
        readingTime: "7 min",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "How to properly store and protect the master key to your crypto.",
        order: 3,
        readingTime: "5 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "2FA, withdrawal whitelists, and choosing a secure exchange.",
        order: 5,
        readingTime: "5 min",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "SEC, CFTC, and the evolving legal framework for digital assets in America.",
        order: 2,
        readingTime: "8 min",
      },
      {
        ...
        description:
          "The Markets in Crypto-Assets regulation and what it means for the industry.",
        order: 3,
        readingTime: "7 min",
      },
      {
        ...
        description:
          "Capital gains, reporting requirements, and tax tools for crypto investors.",
        order: 4,
        readingTime: "7 min",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "How L2s inherit security from L1s while processing transactions off-chain.",
        order: 2,
        readingTime: "7 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Compare Arbitrum, Optimism, Base, zkSync, and other L2s for your needs.",
        order: 6,
        readingTime: "6 min",
      },
    ],
    ...
    articles: [
      {
        ...
        description:
          "Digital dollars on the blockchain: how stablecoins maintain their peg.",
        order: 1,
        readingTime: "6 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Depegging, regulatory threats, and counterparty risks in stablecoins.",
        order: 3,
        readingTime: "6 min",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        description:
          "Voting, delegating, writing proposals, and contributing to DAOs.",
        order: 3,
        readingTime: "6 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Voter apathy, plutocracy risks, legal status, and scaling governance.",
        order: 5,
        readingTime: "5 min",
      },
    ],
    ...
    articles: [
      {
        ...
        description:
          "How artificial intelligence and blockchain technology are converging.",
        order: 1,
        readingTime: "7 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "How blockchain enables distributed GPU power for AI training and inference.",
        order: 3,
        readingTime: "7 min",
      },
      {
      ...
      },
      {
        ...
        description:
          "Separating genuine innovation from speculation in the AI-crypto narrative.",
        order: 5,
        readingTime: "6 min",
      },
    ],
